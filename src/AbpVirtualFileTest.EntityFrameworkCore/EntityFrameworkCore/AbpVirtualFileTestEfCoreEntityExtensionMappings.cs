...
public static class AbpVirtualFileTestEfCoreEntityExtensionMappings
{
    ...
    public static void Configure()
    {
        ...
        OneTimeRunner.Run(() =>
        {
                 ...
                 * USE AbpVirtualFileTestModuleExtensionConfigurator CLASS (in the Domain.Shared project)
